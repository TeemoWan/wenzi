SimpleSchema.messages({
  ...
  regEx: [
    {msg: '不是有效的[label]'},
    {exp: SimpleSchema.RegEx.Email, msg: '[label]必须是一个有效的邮箱地址'}, //'[label] must be a valid e-mail address'},
    {exp: SimpleSchema.RegEx.WeakEmail, msg: '[label]必须是一个有效的邮箱地址'},//'[label] must be a valid e-mail address'
    {exp: SimpleSchema.RegEx.Domain, msg: '[label]必须是个有效的域名'},//'[label] must be a valid domain'
    {exp: SimpleSchema.RegEx.WeakDomain, msg: '[label]必须是一个有效的域名'},//'[label] must be a valid domain'
    {exp: SimpleSchema.RegEx.IP, msg: '[label]必须是一个有效的IPv4或者IPv6地址'},//'[label] must be a valid IPv4 or IPv6 address'
    {exp: SimpleSchema.RegEx.IPv4, msg: '[label]必须是一个有效的IPv4地址'},//'[label] must be a valid IPv4 address'
    {exp: SimpleSchema.RegEx.IPv6, msg: '[label]必须是一个有效的IPv6地址'},//'[label] must be a valid IPv6 address'
    {exp: SimpleSchema.RegEx.Url, msg: '[label]必须是一个有效的网址'},//'[label] must be a valid URL'
    {exp: SimpleSchema.RegEx.Id, msg: '[label]必须是一个由字母和数字组成的ID'}//'[label] must be a valid alphanumeric ID'
  ],
